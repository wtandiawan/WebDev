...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { developer_id: @developer.developer_id, game_id: @developer.game_id, name: @developer.name }
    end
  ...
  test "should update developer" do
    patch :update, id: @developer, developer: { developer_id: @developer.developer_id, game_id: @developer.game_id, name: @developer.name }
    assert_redirected_to developer_path(assigns(:developer))
  end
